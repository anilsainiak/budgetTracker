...
import { GetHistoryDataResponseType, HistoryData } from '@/app/api/history-data/route'
                                ...
                                <ResponsiveContainer width={'100%'} height={300}>
                                    ...
                                    >
                                        ...
                                        <Tooltip cursor={{ opacity: 0.1 }} content={props => (
                                            <CustomTooltip formatter={formatter}
                                                {...props}
                                            />
                                        )}
                                        />
...
const ToolTipRow = ({ label, textColor, bgColor, value, formatter }: {
    label: string;
    textColor: string;
    bgColor: string;
    value: number;
